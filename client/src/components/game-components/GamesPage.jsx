    ...
    const projects = [
      {
        ...
        description: 'Currently in development - a Multiplayer card game in the style of Hearthstone and Magic: the Gathering.',
      ...
      },
      {
        ...
        description: 'My first released game. a single-player sidescroller / ultrahard platformer with a small competitive speed-running community. ',
      ...
      },
      {
        ...
        description: 'Online Strategy Card Game. I made this because my friends didn\'t have a good place to play Coup online.',
