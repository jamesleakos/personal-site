...
function AddComponentSelector({ addComponent }) {
  return (
    <div className='selector-container'>
      <FontAwesomeIcon onClick={(e) => { addComponent('main-title'); }} className='reacting-link expand-cursor' icon='fa-solid fa-book' />
      <FontAwesomeIcon onClick={(e) => { addComponent('subtitle'); }} className='reacting-link expand-cursor' icon='fa-solid fa-book-open' />
      <FontAwesomeIcon onClick={(e) => { addComponent('section-title'); }} className='reacting-link expand-cursor' icon='fa-solid fa-section' />
